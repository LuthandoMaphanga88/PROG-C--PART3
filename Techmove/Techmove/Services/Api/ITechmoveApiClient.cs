...
public interface ITechmoveApiClient
{
    ...
    Task<ClientViewModel?> GetClientAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task UpdateClientAsync(int id, ClientViewModel client, CancellationToken cancellationToken = default);
    ...
    Task UpdateContractAsync(int id, ContractViewModel contract, CancellationToken cancellationToken = default);
    ...
    Task<ServiceRequestViewModel?> GetServiceRequestAsync(int id, CancellationToken cancellationToken = default);
    Task SaveServiceRequestAsync(ServiceRequestViewModel request, int contractId, CancellationToken cancellationToken = default);
    Task UpdateServiceRequestAsync(int id, ServiceRequestViewModel request, CancellationToken cancellationToken = default);
